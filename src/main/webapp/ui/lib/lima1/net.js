...
(function() {
  ...
  jQueryTransport = (function(_super) {
    ...
    function jQueryTransport() {
      return jQueryTransport.__super__.constructor.apply(this, arguments);
    }
    ...
    jQueryTransport.prototype.request = function(config, handler) {
      ...
      return $.ajax({
        ...
        data: (_ref1 = (config != null ? config.data : void 0)) != null ? _ref1 : null,
        contentType: (_ref2 = (config != null ? config.contentType : void 0)) != null ? _ref2 : void 0,
  ...
  OAuthProvider = (function() {
    ...
    OAuthProvider.prototype.tokenByUsernamePassword = function(username, password, handler) {
      ...
      return this.transport.request({
        ...
        if (error) {
          return handler(data != null ? data : error);
        }
