  ...
  AdminApp = (function() {
    ...
    AdminApp.prototype.showUsersInfo = function() {
      ...
      return this.oauth.rest('', '/rest/admin/users/list?', null, function(err, data) {
        var btn, r, rights, td, tr, user, _i, _j, _len, _len2, _ref, _ref2, _ref3, _ref4, _ref5, _results;
    ...
    AdminApp.prototype.editUser = function(info, admin) {
      ...
      return this.oauth.rest('', "/rest/admin/tokens/list?id=" + info.id + "&", null, function(err, data) {
        var btn, item, td, tr, _i, _len, _ref3, _ref4, _ref5, _results;
        if (err) return _this.showError(err);
        _ref3 = data.list;
        _results = [];
    ...
    AdminApp.prototype.showAppsInfo = function() {
      ...
      return this.oauth.rest('', '/rest/admin/apps/list?', null, function(err, data) {
        var btn, item, td, tr, _i, _len, _ref, _ref2, _ref3, _ref4, _results;
        if (err) return _this.showError(err);
        tbody.empty();
        _ref = data != null ? data.list : void 0;
        _results = [];
    ...
    AdminApp.prototype.showDataInfo = function() {
      ...
      return this.oauth.rest('', '/rest/admin/data/list?', null, function(err, data) {
        var item, tr, _i, _len, _ref, _ref2, _ref3, _results;
        if (err) return _this.showError(err);
        tbody.empty();
        _ref = data != null ? data.list : void 0;
        _results = [];
          ...
          _results.push((function(item) {
            ...
            loadStat = function() {
              return _this.oauth.rest(item.app, '/rest/admin/data/stat?', null, function(err, data) {
                var addRow, i, num, size, sizeText, sizes, st, sz, _j, _len2, _ref4, _ref5, _ref6, _ref7;
                statTable.empty();
                ...
                sizeText = '???';
                for (i = 0, _ref7 = sizes.length; 0 <= _ref7 ? i < _ref7 : i > _ref7; 0 <= _ref7 ? i++ : i--) {
                  sz = sizes[i];
            ...
            files.bind('change', function(e) {
              var fileList, _ref4;
              fileList = (_ref4 = files.get(0)) != null ? _ref4.files : void 0;
